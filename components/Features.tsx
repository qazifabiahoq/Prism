    ...
    <section className="relative bg-surface-50 py-20 sm:py-28">
      <div className="container-shell">
        <div className="mx-auto max-w-2xl text-center">
          <span className="text-xs font-bold uppercase tracking-[0.2em] text-navy-600">
            Capabilities
          </span>
        ...
        <div className="mt-14 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURES.map((f, i) => (
            ...
            >
              <div className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-navy-950 text-accent-400 transition group-hover:bg-accent-500 group-hover:text-navy-950">
